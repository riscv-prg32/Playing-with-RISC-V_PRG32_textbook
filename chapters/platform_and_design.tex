...
Audio in \prg starts as simply as it can: \code{prg32\_buzzer\_tone(hz, ms)} plays
...
\begin{prgwarn}
Do not call \code{prg32\_buzzer\_tone} every frame. Trigger sound on events only.
...
directory and profile differ \citep{prg32qemu}.
