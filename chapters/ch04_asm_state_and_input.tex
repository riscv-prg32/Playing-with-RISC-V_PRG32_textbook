...
\lstinputlisting[
    style=asm,
    caption={%
        \fname{examples/ch04/input\_read.S} \protect\\
        A full \code{update}: read input, move on LEFT/RIGHT, store the result. 
        Compare with the platform's \code{pong\_ascii\_update}%
    }
]{examples/ch04/input_read.S}
