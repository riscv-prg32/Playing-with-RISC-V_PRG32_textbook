...
collision, a score, a button press. Don't play it on every frame, because a tone
...
\lstinputlisting[
    ...
    caption={%
        ...
        Building and flashing for the physical board (abbreviated; see Appendix~\ref{app:env}).%
    }
]{scripts/ch02/building_and_flashing_esp32c6.sh}
...
]{scripts/ch02/building_and_flashing_qemu_windows.ps1}

\lstinputlisting[
    style=bash,
    caption={%
        Building and running for the Windows desktop emulator.%
    }
]{scripts/ch02/building_and_flashing_qemu_windows.ps1}
...
]{scripts/ch02/building_and_flashing_qemu_shell.sh}
