...
The console measured position in values; the viewport measures it in
...
clears the screen to black and does nothing else: confirm it runs.

\lstinputlisting[
    style=asm,
    caption={%
        \fname{blank\_graphics.S} \protect\\
       A \code{draw} that clears the frame. Build this first and confirm a black screen before drawing anything on it.%
    }
]{examples/ch05/blank_graphics.S}
