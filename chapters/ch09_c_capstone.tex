...
]{examples/ch09/pong_c_firmware_loop.c}
...
]{examples/ch09/raycast_fixed_point.c}
...
\lstinputlisting[
    style=bash,
    caption={%\fname{build\_pong\_c\_cartridge.sh} \protect\
       Building a C cartridge against the board firmware.}
]{scripts/ch09/build_pong_c_cartridge.sh}
...
\lstinputlisting[
    style=bash,
    caption={%\fname{upload\_pong\_c\_cartridge.sh} \protect\
       Uploading the C cartridge to the board, then the QEMU variant.}
]{scripts/ch09/upload_pong_c_cartridge.sh}
