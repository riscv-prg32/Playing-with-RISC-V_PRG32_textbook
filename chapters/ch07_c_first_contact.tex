...
\lstinputlisting[
    style=c,
    caption={%
        \fname{examples/ch07/hello\_world\_c.c} \protect\\
        The smallest C game. Three functions that do nothing yet: the C counterpart of the assembly skeleton in Chapter~\ref{ch:asm1}.%
    }]{examples/ch07/hello_world_c.c}
