...
\lstinputlisting[style=c,caption={\fname{examples/ch07/hello\_world\_c.c} The smallest C game. Three functions that do nothing yet: the C counterpart of the assembly skeleton in Chapter~\ref{ch:asm1}.}]{examples/ch07/hello_world_c.c}
...
\lstinputlisting[
    style=c,
    caption={%\fname{pong\_c\_state.c} \protect\
...
\lstinputlisting[
    style=c,
    caption={%\fname{pong\_c\_paddle\_collision.c} \protect\
       Bouncing the ball off the paddle. The hitbox test returns non-zero on overlap.}
]{examples/ch07/pong_c_paddle_collision.c}
